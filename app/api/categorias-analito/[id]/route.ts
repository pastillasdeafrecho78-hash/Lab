...
export async function DELETE(
  ...
  try {
    ...
    // Verificar si está siendo usada en tipos de prueba
    if (categoria.tipoPruebas.length > 0) {
      return NextResponse.json(
        {
          success: false,
          error: 'No se puede eliminar la categoría porque está siendo usada en tipos de prueba'
        },
        { status: 400 }
      )
    }
