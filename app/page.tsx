  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success && data.token) {
        ...
        // Luego hacer refresh completo para cargar configuraciones de aspecto
        setTimeout(() => {
        ...
        <div className="card">
          <div className="text-center mb-8">
            <div className="mx-auto h-12 w-12 bg-primary-600 rounded-lg flex items-center justify-center mb-4">
              <svg className="h-8 w-8 text-on-color" fill="none" viewBox="0 0 24 24" stroke="currentColor">
