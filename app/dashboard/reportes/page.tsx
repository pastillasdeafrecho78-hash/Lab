        ...
        {data.map((item, index) => (
          <div key={index}>
            <div className="flex justify-between items-center mb-1">
              ...
              <span className="text-sm text-secondary-600">{item.value}</span>
            </div>
  ...
  const renderLineChart = (data: Array<{ fecha: string; cantidad: number }>) => {
    ...
    return (
      <div className="relative h-64">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-between text-xs text-secondary-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold text-secondary-900">Reportes y Estadísticas</h1>
            </div>
          </div>
        </div>
      </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
              <div className="card">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-secondary-600">Total Comandas</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="card">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-secondary-900">Sucursales</h3>
                </div>
              ...
              <div className="card">
                <div className="flex items-center mb-4">
                  <ChartBarIcon className="h-5 w-5 text-secondary-400 mr-2" />
                  <h3 className="text-lg font-semibold text-secondary-900">Clientes</h3>
                </div>
                <p className="text-3xl font-bold text-secondary-900">
              ...
              <div className="card">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-secondary-900">Usuarios</h3>
                </div>
                <p className="text-3xl font-bold text-secondary-900">
