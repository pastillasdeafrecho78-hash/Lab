  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold text-primary">Gestión de Comandas</h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                {filteredComandas.map((comanda) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium" onClick={(e) => e.stopPropagation()}>
                      {(comanda.estado === 'EN_PROCESO' || comanda.estado === 'PENDIENTE') && (
                        <button
                      ...
                      {comanda.resultados && comanda.resultados.length > 0 && comanda.estado !== 'EN_PROCESO' && (
                        <button
                          onClick={() => router.push(`/dashboard/comandas/${comanda.id}/resultados`)}
        ...
        {/* Sección de Comandas Archivadas */}
        {comandasArchivadas.length > 0 && (
          <div className="mt-8">
            <button
            ...
            >
              <div className="flex items-center gap-3">
                <ArchiveBoxIcon className="h-5 w-5 text-tertiary" />
                <h2 className="text-lg font-semibold text-primary">
                  Comandas Archivadas ({comandasArchivadas.length})
                </h2>
              </div>
              {showArchivadas ? (
              ...
              <div className="mt-4 card">
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-secondary-200">
                    ...
                    <tbody className="bg-gray-100 divide-y divide-secondary-200">
                      {comandasArchivadas.map((comanda) => (
                        <tr 
                          key={comanda.id} 
                        ...
                        >
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-tertiary">
                            {comanda.fechaArchivado 
                              ? new Date(comanda.fechaArchivado).toLocaleDateString('es-ES')
                              : 'N/A'
                            }
                          </td>
                        </tr>
          ...
          <div className="bg-gray-100 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-primary">Nueva Comanda</h2>
                <button
                  onClick={closeModal}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {formData.tipoPruebaId && analitosCategoriaSeleccionada.length > 0 && (
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 max-h-64 overflow-y-auto border border-gray-200 rounded-lg p-3 bg-gray-50">
