...
export default function ComandaDetailPage({ params }: { params: { id: string } }) {
  ...
  const getEstadoColor = (estado: string) => {
    const colors = {
      ...
      ENTREGADA: 'text-secondary'
    }
    return colors[estado as keyof typeof colors] || 'text-secondary'
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              {/* Botón para ver resultados si ya están completos */}
              {comanda.resultados.length > 0 && comanda.estado !== 'EN_PROCESO' && (
                <button
                  onClick={() => router.push(`/dashboard/comandas/${comanda.id}/resultados`)}
                  className="btn btn-secondary btn-sm"
                >
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="card">
              <div className="card-header">
                <h3 className="text-lg font-semibold text-primary">Información del Cliente</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium text-tertiary">Nombre Completo</label>
                ...
                <div>
                  ...
                  <p className="text-primary">{comanda.cliente.email}</p>
                </div>
                {comanda.cliente.telefono && (
                  <div>
                    <label className="text-sm font-medium text-tertiary">Teléfono</label>
                    <p className="text-primary">{comanda.cliente.telefono}</p>
                  </div>
                )}
                {comanda.cliente.fechaNacimiento && (
                  <div>
                    <label className="text-sm font-medium text-tertiary">Fecha de Nacimiento</label>
                    <p className="text-primary">
              ...
              <div className="space-y-4">
                ...
                {comanda.observaciones && (
                  <div>
                    ...
                    <p className="text-primary">{comanda.observaciones}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="card">
              ...
              {comanda.resultados.length === 0 ? (
                <div className="text-center py-8">
                  <BeakerIcon className="h-12 w-12 text-tertiary mx-auto mb-4" />
                  <p className="text-tertiary mb-4">No hay resultados registrados</p>
                  <button
                    onClick={() => router.push(`/dashboard/comandas/${comanda.id}/resultados`)}
                    className="btn btn-primary"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="card">
              <div className="card-header">
                <h3 className="text-lg font-semibold text-primary">Estado y Fechas</h3>
              </div>
              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-tertiary">Estado Actual</label>
                  <p className={`font-semibold ${getEstadoColor(comanda.estado)}`}>
                    {getEstadoLabel(comanda.estado)}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-tertiary">Fecha de Creación</label>
                  <p className="text-primary">
                ...
                {comanda.fechaAsignacion && (
                  <div>
                    <label className="text-sm font-medium text-tertiary">Fecha de Asignación</label>
                    <p className="text-primary">
                ...
                {comanda.fechaCompletado && (
                  <div>
                    <label className="text-sm font-medium text-tertiary">Fecha de Completado</label>
                    <p className="text-primary">
                ...
                {comanda.fechaEntrega && (
                  <div>
                    <label className="text-sm font-medium text-tertiary">Fecha de Entrega</label>
                    <p className="text-primary">
            ...
            <div className="card">
              <div className="card-header">
                <h3 className="text-lg font-semibold text-primary">Sucursal</h3>
              </div>
              <div className="space-y-2">
                <div>
                  <label className="text-sm font-medium text-tertiary">Nombre</label>
                  <p className="text-primary">{comanda.sucursal.nombre}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-tertiary">Dirección</label>
                  <p className="text-primary">{comanda.sucursal.direccion}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-tertiary">Teléfono</label>
                  <p className="text-primary">{comanda.sucursal.telefono}</p>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              <div className="card-header">
                <h3 className="text-lg font-semibold text-primary">Personal</h3>
              </div>
              <div className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-tertiary">Creado Por</label>
                  <p className="text-primary">
                ...
                {comanda.asignadoA && (
                  <div>
                    <label className="text-sm font-medium text-tertiary">Asignado A</label>
                    <p className="text-primary">
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-secondary mt-1">{cambio.descripcion}</p>
          ...
          <div className="bg-gray-100 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto my-4">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-semibold text-primary">Editar Comanda</h2>
                <button
